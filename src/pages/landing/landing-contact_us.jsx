            ...
            <div className="grid grid-cols-12 gap-5">
                ...
                <div className="col-span-8 pl-20">
                    <form className="w-full">
                        <div className="flex mb-[46px] gap-9">
                            <div className="w-1/2">
                        ...
                        <div className=" mb-12">
                            ...
                            <textarea id="message" placeholder="Enter your messages..." className="block w-full text-gray-700 border-2 border-gray-300 rounded-xl py-4 px-5 focus:outline-none" rows="5"></textarea>
                        </div>
                        <button type="submit" className="bg-[#E5AF10] text-white py-3 px-7 rounded-md text-xl font-semibold font-inter">Submit</button>
                    </form>
                </div>
            </div>
        </div>
